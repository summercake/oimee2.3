<div class="user-sidebar bg-light p-4 ">
    <ul class="list-unstyled">
        ...
        <li>
            <div class="row justify-content-center mb-2">
                <a href="javascript:;" class="mx-3" data-toggle="tooltip" title="实名认证" data-placement="right"><i class="far fa-user"></i></a>
                <a href="javascript:;" class="mx-3" data-toggle="tooltip" title="绑定手机" data-placement="top"><i class="fas fa-mobile-alt"></i></a>
                <a href="javascript:;" class="mx-3" data-toggle="tooltip" title="绑定邮箱" data-placement="top"><i class="far fa-envelope"></i></a>
            </div>
        </li>
    </ul>
    <hr>
    <ul class="list-unstyled text-center">
        ...
        <li><a href="{{route('user.pwd.edit', Auth::id())}}">修改密码</a></li>
        {{--<li><a href="">手机绑定</a></li>--}}
        {{--<li><a href="">实名认证</a></li>--}}
        <li><a href="">消息中心</a></li>
        <li><a href="">联系客服</a></li>
