<div class="media bg-light p-4 d-none d-xl-block d-lg-block" id="complete-dis-info">
    <div class="row">
        <div class="col-4">
            <a href="{{route('discount-details')}}"><img class="img-fluid" src="{{asset('/img/boots.jpg')}}" alt=""></a>
        </div>
        <div class="col-8">
